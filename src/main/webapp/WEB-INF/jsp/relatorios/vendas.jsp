<%-- DesafioDunnas/src/main/webapp/WEB-INF/jsp/relatorios/vendas.jsp --%>
...
<div class="container mt-5">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="/fornecedor/relatorios/vendas" method="get" class="mb-4">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <c:forEach var="pedido" items="${vendas}">
                    <tr>
                        <td>${pedido.id}</td>
                        <td>${pedido.cliente.nome}</td>
                        <td>
                            <fmt:setLocale value="pt-BR"/>
                            <fmt:formatNumber value="${pedido.valor_total}" type="currency"/>
                        </td>
                        <td>
